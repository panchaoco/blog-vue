<template>
  <section class="comment-container">
    <div class="input-comment">
      <Input type="textarea" v-model="commentText" :rows="3" placeholder="输入评论" />
      <div class="profile-wrapper">
        <blog-emoji @choiceEmoji="choiceEmoji" :visible="addEmoji"></blog-emoji>
        <div class="btn">
          <Button v-show="!addEmoji" @click="addEmoji = true">添加表情</Button>
          <Button v-show="addEmoji" @click="addEmoji = false">收起表情</Button>
